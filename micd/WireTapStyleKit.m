...
//  wiretap
//
//  Created by Timmietch on 3/10/15.
...
{
    //// Color Declarations
    UIColor* color6 = [UIColor colorWithRed: 0.149 green: 0.149 blue: 0.149 alpha: 1];

    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(2, 2, 26, 25) cornerRadius: 1];
    [color6 setFill];
    [rectanglePath fill];
}
