...
+ (void)drawSingleRecordingCell
{
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(17.5, 10.5, 37, 36)];
    CGContextSaveGState(context);
    ...
    //// Oval 3 Drawing
    UIBezierPath* oval3Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(320.5, 10.5, 37, 36)];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
    [gradientColor setFill];
    [oval3Path fill];
