...
//  wiretap
//
//  Created by Timmietch on 3/9/15.
...
+ (void)drawEditCircle
{
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = UIBezierPath.bezierPath;
    [rectanglePath moveToPoint: CGPointMake(21.08, 7.92)];
    [rectanglePath addLineToPoint: CGPointMake(21.08, 7.92)];
    [rectanglePath addLineToPoint: CGPointMake(21.08, 7.92)];
    [rectanglePath addLineToPoint: CGPointMake(21.13, 7.97)];
    [rectanglePath addCurveToPoint: CGPointMake(21.41, 9.55) controlPoint1: CGPointMake(21.55, 8.39) controlPoint2: CGPointMake(21.66, 9.02)];
    [rectanglePath addCurveToPoint: CGPointMake(20.54, 10.58) controlPoint1: CGPointMake(21.24, 9.88) controlPoint2: CGPointMake(21.01, 10.11)];
    [rectanglePath addLineToPoint: CGPointMake(13.36, 17.76)];
    [rectanglePath addCurveToPoint: CGPointMake(10.74, 20.24) controlPoint1: CGPointMake(11.26, 19.87) controlPoint2: CGPointMake(11.02, 20.1)];
    [rectanglePath addLineToPoint: CGPointMake(10.69, 20.27)];
    [rectanglePath addCurveToPoint: CGPointMake(7, 22) controlPoint1: CGPointMake(10.16, 20.52) controlPoint2: CGPointMake(7, 22)];
    [rectanglePath addCurveToPoint: CGPointMake(8.73, 18.31) controlPoint1: CGPointMake(7, 22) controlPoint2: CGPointMake(8.48, 18.84)];
    [rectanglePath addCurveToPoint: CGPointMake(9.6, 17.28) controlPoint1: CGPointMake(8.9, 17.98) controlPoint2: CGPointMake(9.13, 17.74)];
    [rectanglePath addLineToPoint: CGPointMake(11.24, 15.64)];
    [rectanglePath addCurveToPoint: CGPointMake(19.4, 7.62) controlPoint1: CGPointMake(18.89, 7.99) controlPoint2: CGPointMake(19.12, 7.76)];
    [rectanglePath addLineToPoint: CGPointMake(19.45, 7.59)];
    [rectanglePath addCurveToPoint: CGPointMake(21.03, 7.87) controlPoint1: CGPointMake(19.98, 7.34) controlPoint2: CGPointMake(20.61, 7.45)];
    [rectanglePath addCurveToPoint: CGPointMake(21.08, 7.92) controlPoint1: CGPointMake(21.08, 7.92) controlPoint2: CGPointMake(21.08, 7.92)];
    [rectanglePath addLineToPoint: CGPointMake(21.08, 7.92)];
    [rectanglePath closePath];
    [color5 setFill];
    [rectanglePath fill];
    ...
    //// Rectangle 2 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 19.12, 9.88);
    CGContextRotateCTM(context, 45 * M_PI / 180);

    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(-2.5, -0.5, 5, 1)];
    [black setFill];
    [rectangle2Path fill];
    ...
    //// Rectangle 3 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 10.12, 18.88);
    CGContextRotateCTM(context, 45 * M_PI / 180);

    UIBezierPath* rectangle3Path = [UIBezierPath bezierPathWithRect: CGRectMake(-2.5, -0.5, 5, 1)];
    [black setFill];
    [rectangle3Path fill];
