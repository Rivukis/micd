...
//  wiretap
//
//  Created by Timmietch on 4/26/15.
...
+ (void)drawMicPermissionWatch
{
    ...
    CGRect looksLikeYourPhoneNeedsMicrophoneAccessRect = CGRectMake(0, 77, 296, 219);
    {
        ...
        NSDictionary* looksLikeYourPhoneNeedsMicrophoneAccessFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"HelveticaNeue-Medium" size: 33], NSForegroundColorAttributeName: vibrantBlue, NSParagraphStyleAttributeName: looksLikeYourPhoneNeedsMicrophoneAccessStyle};
