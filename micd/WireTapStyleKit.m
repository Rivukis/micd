...
//  wiretap
//
//  Created by Timmietch on 4/6/15.
...
{
    //// Color Declarations
    UIColor* recordRed = [UIColor colorWithRed: 0.992 green: 0.188 blue: 0.11 alpha: 1];
...
+ (void)drawMicdRecordIconWithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle strokeWidth: (CGFloat)strokeWidth
{
    ...
    //// Oval 2 Drawing
    CGRect oval2Rect = CGRectMake(25, 25, 246, 246);
    UIBezierPath* oval2Path = UIBezierPath.bezierPath;
    ...
    //// Oval 7 Drawing
    UIBezierPath* oval7Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(30, 30.47, 236, 236)];
    [black setFill];
    [oval7Path fill];
    [color5 setStroke];
    ...
    {
        //// Rectangle 8 Drawing
        UIBezierPath* rectangle8Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(128, 102.48, 40, 71.99) cornerRadius: 20];
        [recordRed setFill];
        [rectangle8Path fill];
        ...
        [rectangle9Path moveToPoint: CGPointMake(148.56, 158.97)];
        [rectangle9Path addCurveToPoint: CGPointMake(174.94, 149.97) controlPoint1: CGPointMake(148.56, 158.97) controlPoint2: CGPointMake(174.99, 145.82)];
        [rectangle9Path addCurveToPoint: CGPointMake(173.37, 167.47) controlPoint1: CGPointMake(174.89, 154.12) controlPoint2: CGPointMake(175.57, 162.47)];
        [rectangle9Path addCurveToPoint: CGPointMake(151.82, 182.06) controlPoint1: CGPointMake(170.5, 175.5) controlPoint2: CGPointMake(163.95, 181.06)];
        [rectangle9Path addLineToPoint: CGPointMake(146.63, 182.06)];
        [rectangle9Path addCurveToPoint: CGPointMake(122.57, 166.43) controlPoint1: CGPointMake(135.86, 182.06) controlPoint2: CGPointMake(126.25, 175.81)];
        [rectangle9Path addCurveToPoint: CGPointMake(121.07, 149.47) controlPoint1: CGPointMake(120.51, 160.39) controlPoint2: CGPointMake(121.11, 153.31)];
        [rectangle9Path addCurveToPoint: CGPointMake(148.56, 158.97) controlPoint1: CGPointMake(121.03, 145.63) controlPoint2: CGPointMake(148.56, 158.97)];
        ...
        //// Rectangle 13 Drawing
        UIBezierPath* rectangle13Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(128, 191.47, 40, 6) cornerRadius: 2];
        [recordRed setFill];
        [rectangle13Path fill];


        //// Rectangle 14 Drawing
        UIBezierPath* rectangle14Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(145, 180.47, 6, 15) cornerRadius: 3];
        [recordRed setFill];
        [rectangle14Path fill];
    }
}
...
+ (void)drawIphone6plus
{
    ...
    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(-103, -103, 386, 386);
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);
    CGContextScaleCTM(context, symbolRect.size.width / 296, symbolRect.size.height / 296);

    [WireTapStyleKit drawMicdRecordIconWithArcEndAngle: 0 arcStartAngle: 1 strokeWidth: 10];
    CGContextRestoreGState(context);
}
...
+ (void)drawRecordButtonWithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    ...
    //// Rectangle 13 Drawing
    UIBezierPath* rectangle13Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(108, 166, 40, 6) cornerRadius: 2];
    [black setFill];
    [rectangle13Path fill];


    //// Rectangle 14 Drawing
    UIBezierPath* rectangle14Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(125, 155, 6, 15) cornerRadius: 3];
    [black setFill];
    [rectangle14Path fill];


    //// Rectangle 8 Drawing
    UIBezierPath* rectangle8Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(111.89, 83, 32.11, 65) cornerRadius: 11];
    [black setFill];
    [rectangle8Path fill];
    ...
    //// Bezier 2 Drawing
    UIBezierPath* bezier2Path = UIBezierPath.bezierPath;
    [bezier2Path moveToPoint: CGPointMake(149.83, 139.53)];
    [bezier2Path addLineToPoint: CGPointMake(149.61, 140.45)];
    [bezier2Path addCurveToPoint: CGPointMake(128.83, 155) controlPoint1: CGPointMake(146.43, 149.18) controlPoint2: CGPointMake(138.12, 155)];
    [bezier2Path addLineToPoint: CGPointMake(126.45, 155)];
    [bezier2Path addCurveToPoint: CGPointMake(105.67, 140.45) controlPoint1: CGPointMake(117.15, 155) controlPoint2: CGPointMake(108.85, 149.18)];
    [bezier2Path addCurveToPoint: CGPointMake(104, 129.49) controlPoint1: CGPointMake(104.6, 137.06) controlPoint2: CGPointMake(104.17, 133.82)];
    [bezier2Path addCurveToPoint: CGPointMake(106.97, 129.5) controlPoint1: CGPointMake(104.14, 129.49) controlPoint2: CGPointMake(105.22, 129.49)];
    [bezier2Path addCurveToPoint: CGPointMake(108.46, 139.66) controlPoint1: CGPointMake(107.11, 133.56) controlPoint2: CGPointMake(107.48, 136.54)];
    [bezier2Path addCurveToPoint: CGPointMake(126.84, 152.53) controlPoint1: CGPointMake(111.27, 147.39) controlPoint2: CGPointMake(118.62, 152.53)];
    [bezier2Path addLineToPoint: CGPointMake(128.94, 152.53)];
    [bezier2Path addCurveToPoint: CGPointMake(147.32, 139.66) controlPoint1: CGPointMake(137.16, 152.53) controlPoint2: CGPointMake(144.5, 147.39)];
    [bezier2Path addLineToPoint: CGPointMake(147.51, 138.86)];
    [bezier2Path addCurveToPoint: CGPointMake(148.86, 129.48) controlPoint1: CGPointMake(148.53, 135.77) controlPoint2: CGPointMake(148.8, 132.43)];
    [bezier2Path addCurveToPoint: CGPointMake(151.38, 129.47) controlPoint1: CGPointMake(150.34, 129.48) controlPoint2: CGPointMake(151.24, 129.47)];
    [bezier2Path addCurveToPoint: CGPointMake(149.83, 139.53) controlPoint1: CGPointMake(151.36, 130.95) controlPoint2: CGPointMake(151.19, 135.44)];
    [bezier2Path closePath];
    bezier2Path.lineCapStyle = kCGLineCapRound;
