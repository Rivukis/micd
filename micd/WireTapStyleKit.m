...
static UIImage* _imageOfSettingsView = nil;
...
+ (void)drawPauseAsset
{
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(5.5, 5.5, 29, 29)];
    [vibrantBlue setStroke];
    ovalPath.lineWidth = 1;
    [ovalPath stroke];
    ...
    //// Bezier 2 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 21, 19.5);
    CGContextRotateCTM(context, 90 * M_PI / 180);
...
+ (void)drawClearButton
{
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(0.5, 0.5, 14, 14)];
    [vibrantBlue setStroke];
    ovalPath.lineWidth = 1;
    [ovalPath stroke];
    ...
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(-0.5, -4, 1, 8) cornerRadius: 0.5];
    [vibrantBlue setFill];
    [rectanglePath fill];
    ...
    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(-0.5, -4, 1, 8) cornerRadius: 0.5];
    [vibrantBlue setFill];
    [rectangle2Path fill];
...
+ (void)drawPlayAssetWithArcStart: (CGFloat)arcStart arcEnd: (CGFloat)arcEnd
{
    ...
    //// Oval Drawing
    CGRect ovalRect = CGRectMake(5.5, 5.5, 29, 29);
    UIBezierPath* ovalPath = UIBezierPath.bezierPath;
    ...
    //// Rectangle 2 Drawing
    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(14, 13, 3.5, 14) cornerRadius: 1];
    [vibrantBlue setFill];
    [rectangle2Path fill];
    [vibrantBlue setStroke];
    rectangle2Path.lineWidth = 1;
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(22.5, 13, 3.5, 14) cornerRadius: 1];
    [vibrantBlue setFill];
    [rectanglePath fill];
    [vibrantBlue setStroke];
    rectanglePath.lineWidth = 1;
...
{
    if (_imageOfSettingsView)
        return _imageOfSettingsView;

    UIGraphicsBeginImageContextWithOptions(CGSizeMake(375, 667), NO, 0.0f);
    [WireTapStyleKit drawSettingsView];

    _imageOfSettingsView = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
...
- (void)setSettingsViewTargets: (NSArray*)settingsViewTargets
{
    _settingsViewTargets = settingsViewTargets;

    for (id target in self.settingsViewTargets)
        [target setImage: WireTapStyleKit.imageOfSettingsView];
}
