...
//  wiretap
//
//  Created by Timmietch on 4/29/15.
...
+ (void)drawShareButton
{
    ...
    //// Oval 2 Drawing
    UIBezierPath* oval2Path = UIBezierPath.bezierPath;
    [oval2Path moveToPoint: CGPointMake(39.07, 12.36)];
    [oval2Path addCurveToPoint: CGPointMake(48.89, 38.96) controlPoint1: CGPointMake(49.23, 17.03) controlPoint2: CGPointMake(53.62, 28.94)];
    [oval2Path addCurveToPoint: CGPointMake(21.93, 48.64) controlPoint1: CGPointMake(44.15, 48.98) controlPoint2: CGPointMake(32.08, 53.31)];
    [oval2Path addCurveToPoint: CGPointMake(12.11, 22.04) controlPoint1: CGPointMake(11.77, 43.97) controlPoint2: CGPointMake(7.38, 32.06)];
    [oval2Path addCurveToPoint: CGPointMake(21.93, 12.36) controlPoint1: CGPointMake(14.13, 17.78) controlPoint2: CGPointMake(17.6, 14.35)];
...
{
    if (_imageOfShareButtonHalfSize)
        return _imageOfShareButtonHalfSize;

    UIGraphicsBeginImageContextWithOptions(CGSizeMake(30, 30), NO, 0.0f);
    [WireTapStyleKit drawShareButtonHalfSize];

    _imageOfShareButtonHalfSize = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
...
- (void)setShareButtonHalfSizeTargets: (NSArray*)shareButtonHalfSizeTargets
{
    _shareButtonHalfSizeTargets = shareButtonHalfSizeTargets;
