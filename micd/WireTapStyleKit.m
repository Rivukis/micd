...
//  wiretap
//
//  Created by Timmietch on 4/5/15.
...
+ (void)drawRecordButtonWithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle strokeWidth: (CGFloat)strokeWidth
{
    ...
    //// Group
    {
        ...
        [rectangle9Path moveToPoint: CGPointMake(128.53, 135.97)];
        [rectangle9Path addCurveToPoint: CGPointMake(153.44, 126.97) controlPoint1: CGPointMake(128.53, 135.97) controlPoint2: CGPointMake(153.49, 122.82)];
        [rectangle9Path addCurveToPoint: CGPointMake(151.96, 144.47) controlPoint1: CGPointMake(153.39, 131.12) controlPoint2: CGPointMake(154.04, 139.47)];
        [rectangle9Path addCurveToPoint: CGPointMake(131.61, 159.06) controlPoint1: CGPointMake(148.31, 152.5) controlPoint2: CGPointMake(143.06, 158.06)];
        [rectangle9Path addLineToPoint: CGPointMake(126.7, 159.06)];
        [rectangle9Path addCurveToPoint: CGPointMake(103.98, 143.43) controlPoint1: CGPointMake(116.54, 159.06) controlPoint2: CGPointMake(107.46, 152.81)];
        [rectangle9Path addCurveToPoint: CGPointMake(102.56, 126.47) controlPoint1: CGPointMake(102.03, 137.39) controlPoint2: CGPointMake(102.6, 130.31)];
        [rectangle9Path addCurveToPoint: CGPointMake(128.53, 135.97) controlPoint1: CGPointMake(102.52, 122.63) controlPoint2: CGPointMake(128.53, 135.97)];
...
+ (void)drawLoveMicdWithColor7: (UIColor*)color7
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Group
    {
        ...
        CGRect textRect = CGRectMake(50.09, -0, 121.62, 39.88);
        {
            ...
            NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"HelveticaNeue-Bold" size: UIFont.buttonFontSize], NSForegroundColorAttributeName: color7, NSParagraphStyleAttributeName: textStyle};
        ...
        CGRect text2Rect = CGRectMake(264.79, 7.57, 31.51, 33.3);
        {
            ...
            NSDictionary* text2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"HelveticaNeue-Bold" size: 24], NSForegroundColorAttributeName: color7, NSParagraphStyleAttributeName: text2Style};
...
+ (void)drawAnyCommentsWithColor7: (UIColor*)color7
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    CGRect anySuggestionsRect = CGRectMake(-0, 5, 311, 39.88);
    {
        ...
        NSDictionary* anySuggestionsFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"HelveticaNeue-Bold" size: 16], NSForegroundColorAttributeName: color7, NSParagraphStyleAttributeName: anySuggestionsStyle};
...
+ (UIImage*)imageOfLoveMicdWithColor7: (UIColor*)color7
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(311, 45), NO, 0.0f);
    [WireTapStyleKit drawLoveMicdWithColor7: color7];

    UIImage* imageOfLoveMicd = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();

    return imageOfLoveMicd;
}

+ (UIImage*)imageOfAnyCommentsWithColor7: (UIColor*)color7
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(311, 45), NO, 0.0f);
    [WireTapStyleKit drawAnyCommentsWithColor7: color7];

    UIImage* imageOfAnyComments = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();

    return imageOfAnyComments;
}
