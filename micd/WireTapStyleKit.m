...
//  wiretap
//
//  Created by Timmietch on 3/14/15.
...
+ (void)drawGripCircle
{
    ...
    CGGradientRef gradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)gradientColor.CGColor, (id)UIColor.redColor.CGColor], gradientLocations);
...
{
    //// Color Declarations
    UIColor* color5 = [UIColor colorWithRed: 0.059 green: 0.345 blue: 0.42 alpha: 1];
...
+ (void)drawRewindButtonWithAmountBack: (NSString*)amountBack
{
    ...
    NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"ArialRoundedMTBold" size: UIFont.smallSystemFontSize], NSForegroundColorAttributeName: gradientColor, NSParagraphStyleAttributeName: textStyle};
...
+ (void)drawForwardButtonWithAmountForward: (NSString*)amountForward
{
    ...
    NSDictionary* text2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"ArialRoundedMTBold" size: UIFont.smallSystemFontSize], NSForegroundColorAttributeName: gradientColor, NSParagraphStyleAttributeName: text2Style};
...
+ (UIImage*)imageOfProgressTimeIndicatorView
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(29, 30), NO, 0.0f);
