...
//  wiretap
//
//  Created by Timmietch on 4/7/15.
...
+ (void)drawRecordButton1WithColor7: (UIColor*)color7 arcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    //// Color Declarations
    UIColor* recordRed = [UIColor colorWithRed: 1 green: 0.287 blue: 0.217 alpha: 1];

    //// Oval 81 Drawing
    UIBezierPath* oval81Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(119, 128, 1, 1)];
    [recordRed setFill];
    [oval81Path fill];
    ...
    UIBezierPath* rectangle13Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(108, 167, 40, 6) cornerRadius: 2];
    [recordRed setFill];
    [rectangle13Path fill];


    //// Rectangle 14 Drawing
    UIBezierPath* rectangle14Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(125, 156, 6, 15) cornerRadius: 3];
    [recordRed setFill];
    [rectangle14Path fill];


    //// Rectangle 8 Drawing
    UIBezierPath* rectangle8Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(111.89, 84, 32.11, 65) cornerRadius: 11];
    [recordRed setFill];
    [rectangle8Path fill];
    ...
    //// Bezier 2 Drawing
    UIBezierPath* bezier2Path = UIBezierPath.bezierPath;
    [bezier2Path moveToPoint: CGPointMake(149.83, 140.53)];
    [bezier2Path addLineToPoint: CGPointMake(149.61, 141.45)];
    [bezier2Path addCurveToPoint: CGPointMake(128.83, 156) controlPoint1: CGPointMake(146.43, 150.18) controlPoint2: CGPointMake(138.12, 156)];
    [bezier2Path addLineToPoint: CGPointMake(126.45, 156)];
    [bezier2Path addCurveToPoint: CGPointMake(105.67, 141.45) controlPoint1: CGPointMake(117.15, 156) controlPoint2: CGPointMake(108.85, 150.18)];
    [bezier2Path addCurveToPoint: CGPointMake(104, 130.49) controlPoint1: CGPointMake(104.6, 138.06) controlPoint2: CGPointMake(104.17, 134.82)];
    [bezier2Path addCurveToPoint: CGPointMake(106.97, 130.5) controlPoint1: CGPointMake(104.14, 130.49) controlPoint2: CGPointMake(105.22, 130.49)];
    [bezier2Path addCurveToPoint: CGPointMake(108.46, 140.66) controlPoint1: CGPointMake(107.11, 134.56) controlPoint2: CGPointMake(107.48, 137.54)];
    [bezier2Path addCurveToPoint: CGPointMake(126.84, 153.53) controlPoint1: CGPointMake(111.27, 148.39) controlPoint2: CGPointMake(118.62, 153.53)];
    [bezier2Path addLineToPoint: CGPointMake(128.94, 153.53)];
    [bezier2Path addCurveToPoint: CGPointMake(147.32, 140.66) controlPoint1: CGPointMake(137.16, 153.53) controlPoint2: CGPointMake(144.5, 148.39)];
    [bezier2Path addLineToPoint: CGPointMake(147.51, 139.86)];
    [bezier2Path addCurveToPoint: CGPointMake(148.86, 130.48) controlPoint1: CGPointMake(148.53, 136.77) controlPoint2: CGPointMake(148.8, 133.43)];
    [bezier2Path addCurveToPoint: CGPointMake(151.38, 130.47) controlPoint1: CGPointMake(150.34, 130.48) controlPoint2: CGPointMake(151.24, 130.47)];
    [bezier2Path addCurveToPoint: CGPointMake(149.83, 140.53) controlPoint1: CGPointMake(151.36, 131.95) controlPoint2: CGPointMake(151.19, 136.44)];
    [bezier2Path closePath];
...
+ (void)drawRecordButtonWithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
...
+ (void)drawRecordButtonHighlighted
{
    ...
    //// Oval Drawing
    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(20, 20, 216, 216)];
    [recordRed setFill];
    [ovalPath fill];
...
+ (void)drawMic
{
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(11, 76, 32, 6) cornerRadius: 2];
    [black setFill];
    [rectanglePath fill];


    //// Rectangle 2 Drawing
    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(24, 62, 6, 18) cornerRadius: 3];
    [black setFill];
    [rectangle2Path fill];


    //// Rectangle 3 Drawing
    UIBezierPath* rectangle3Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(10.89, 0, 32.11, 58) cornerRadius: 11];
    [black setFill];
    [rectangle3Path fill];
    ...
    //// Bezier Drawing
    UIBezierPath* bezierPath = UIBezierPath.bezierPath;
    [bezierPath moveToPoint: CGPointMake(48.83, 49.53)];
    [bezierPath addLineToPoint: CGPointMake(48.61, 50.45)];
    [bezierPath addCurveToPoint: CGPointMake(27.83, 65) controlPoint1: CGPointMake(45.43, 59.18) controlPoint2: CGPointMake(37.12, 65)];
    [bezierPath addLineToPoint: CGPointMake(25.45, 65)];
    [bezierPath addCurveToPoint: CGPointMake(4.67, 50.45) controlPoint1: CGPointMake(16.15, 65) controlPoint2: CGPointMake(7.85, 59.18)];
    [bezierPath addCurveToPoint: CGPointMake(3, 39.49) controlPoint1: CGPointMake(3.6, 47.06) controlPoint2: CGPointMake(3.17, 43.82)];
    [bezierPath addCurveToPoint: CGPointMake(5.97, 39.5) controlPoint1: CGPointMake(3.14, 39.49) controlPoint2: CGPointMake(4.22, 39.49)];
    [bezierPath addCurveToPoint: CGPointMake(7.46, 49.66) controlPoint1: CGPointMake(6.11, 43.56) controlPoint2: CGPointMake(6.48, 46.54)];
    [bezierPath addCurveToPoint: CGPointMake(25.84, 62.53) controlPoint1: CGPointMake(10.27, 57.39) controlPoint2: CGPointMake(17.62, 62.53)];
    [bezierPath addLineToPoint: CGPointMake(27.94, 62.53)];
    [bezierPath addCurveToPoint: CGPointMake(46.32, 49.66) controlPoint1: CGPointMake(36.16, 62.53) controlPoint2: CGPointMake(43.5, 57.39)];
    [bezierPath addLineToPoint: CGPointMake(46.51, 48.86)];
    [bezierPath addCurveToPoint: CGPointMake(47.86, 39.48) controlPoint1: CGPointMake(47.53, 45.77) controlPoint2: CGPointMake(47.8, 42.43)];
    [bezierPath addCurveToPoint: CGPointMake(50.38, 39.47) controlPoint1: CGPointMake(49.34, 39.48) controlPoint2: CGPointMake(50.24, 39.47)];
    [bezierPath addCurveToPoint: CGPointMake(48.83, 49.53) controlPoint1: CGPointMake(50.36, 40.95) controlPoint2: CGPointMake(50.19, 45.44)];
    [bezierPath closePath];
    ...
    //// Rectangle 4 Drawing
    UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(1.5, 35.5, 6, 6.5) cornerRadius: 2];
    [black setFill];
    [rectangle4Path fill];


    //// Rectangle 5 Drawing
    UIBezierPath* rectangle5Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(46.36, 35.5, 5.5, 7.5) cornerRadius: 2];
    [black setFill];
    [rectangle5Path fill];
}
...
+ (UIImage*)imageOfRecordButton1WithColor7: (UIColor*)color7 arcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(256, 256), NO, 0.0f);
    [WireTapStyleKit drawRecordButton1WithColor7: color7 arcEndAngle: arcEndAngle arcStartAngle: arcStartAngle];
...
+ (UIImage*)imageOfRecordButtonWithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(256, 256), NO, 0.0f);
    [WireTapStyleKit drawRecordButtonWithArcEndAngle: arcEndAngle arcStartAngle: arcStartAngle];
