...
//  wiretap
//
//  Created by Timmietch on 4/16/15.
...
+ (void)drawRecordButton1WithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    ...
    //// Color Declarations
    UIColor* recordRed = [UIColor colorWithRed: 1 green: 0.361 blue: 0.298 alpha: 1];
...
+ (void)drawIconRed
{
    ...
    //// Color Declarations
    UIColor* recordRed = [UIColor colorWithRed: 1 green: 0.361 blue: 0.298 alpha: 1];
    UIColor* gradient5Color = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.102];
    UIColor* gradient5Color2 = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.111];

    //// Gradient Declarations
    CGFloat gradient5Locations[] = {0.54, 0.65, 0.79};
    ...
    //// Rectangle 4 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, -12.66, 18.91);
    CGContextRotateCTM(context, -57.03 * M_PI / 180);

    UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRect: CGRectMake(-235.19, -243.76, 470.38, 487.51)];
    CGContextSaveGState(context);
    [rectangle4Path addClip];
    CGContextDrawLinearGradient(context, gradient5, CGPointMake(-0, -243.76), CGPointMake(0, 243.76), 0);
    CGContextRestoreGState(context);
...
+ (void)drawCanvas1WithArcEndAngle: (CGFloat)arcEndAngle arcStartAngle: (CGFloat)arcStartAngle
{
    ...
    //// Color Declarations
    UIColor* recordRed = [UIColor colorWithRed: 1 green: 0.361 blue: 0.298 alpha: 1];
    UIColor* gradient6Color = [UIColor colorWithRed: 0.992 green: 0.188 blue: 0.11 alpha: 1];
    UIColor* gradient6Color2 = [UIColor colorWithRed: 0.992 green: 0.271 blue: 0.204 alpha: 1];

    //// Gradient Declarations
    CGFloat gradient6Locations[] = {0.61, 0.61};
    CGGradientRef gradient6 = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)gradient6Color2.CGColor, (id)gradient6Color.CGColor], gradient6Locations);

    //// Oval 2 Drawing
    CGRect oval2Rect = CGRectMake(171, 48, 250, 250);
    UIBezierPath* oval2Path = UIBezierPath.bezierPath;
    [oval2Path addArcWithCenter: CGPointMake(CGRectGetMidX(oval2Rect), CGRectGetMidY(oval2Rect)) radius: CGRectGetWidth(oval2Rect) / 2 startAngle: -(arcEndAngle - 93) * M_PI/180 endAngle: -(arcStartAngle - 463) * M_PI/180 clockwise: YES];
    ...
    //// Oval Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 295.54, 173);
    CGContextRotateCTM(context, -49.36 * M_PI / 180);

    UIBezierPath* ovalPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(-112, -112, 224, 224)];
    CGContextSaveGState(context);
    [ovalPath addClip];
    CGContextDrawLinearGradient(context, gradient6, CGPointMake(-0, -112), CGPointMake(0, 112), 0);
    CGContextRestoreGState(context);
...
+ (void)drawMic
{
    ...
    [rectangle2Path moveToPoint: CGPointMake(22.5, 76)];
    [rectangle2Path addLineToPoint: CGPointMake(27.27, 76)];
    [rectangle2Path addLineToPoint: CGPointMake(27.57, 54.73)];
    [rectangle2Path addCurveToPoint: CGPointMake(25.5, 55.5) controlPoint1: CGPointMake(27.57, 54.73) controlPoint2: CGPointMake(26.62, 55.12)];
    [rectangle2Path addCurveToPoint: CGPointMake(23, 56) controlPoint1: CGPointMake(24.38, 55.88) controlPoint2: CGPointMake(23, 56)];
    [rectangle2Path addLineToPoint: CGPointMake(22.5, 76)];
    ...
    //// Rectangle 3 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 28.14, 27.32);
    ...
    [rectanglePath moveToPoint: CGPointMake(16.02, 18.61)];
    [rectanglePath addCurveToPoint: CGPointMake(25.56, 19.73) controlPoint1: CGPointMake(16.02, 18.61) controlPoint2: CGPointMake(20.31, 17.73)];
    [rectanglePath addCurveToPoint: CGPointMake(33.85, 26.45) controlPoint1: CGPointMake(30.81, 21.73) controlPoint2: CGPointMake(33.85, 26.45)];
    [rectanglePath addCurveToPoint: CGPointMake(34.77, 25) controlPoint1: CGPointMake(33.85, 26.45) controlPoint2: CGPointMake(34.77, 26)];
    [rectanglePath addCurveToPoint: CGPointMake(26.21, 17.97) controlPoint1: CGPointMake(34.77, 25) controlPoint2: CGPointMake(31.46, 19.97)];
    [rectanglePath addCurveToPoint: CGPointMake(16.77, 17) controlPoint1: CGPointMake(20.96, 15.97) controlPoint2: CGPointMake(16.77, 17)];
    [rectanglePath addLineToPoint: CGPointMake(16.02, 18.61)];
    ...
    [rectangle4Path moveToPoint: CGPointMake(19.02, 13.61)];
    [rectangle4Path addCurveToPoint: CGPointMake(28.56, 14.73) controlPoint1: CGPointMake(19.02, 13.61) controlPoint2: CGPointMake(23.31, 12.73)];
    [rectangle4Path addCurveToPoint: CGPointMake(36.85, 21.45) controlPoint1: CGPointMake(33.81, 16.73) controlPoint2: CGPointMake(36.85, 21.45)];
    [rectangle4Path addCurveToPoint: CGPointMake(37.77, 20) controlPoint1: CGPointMake(36.85, 21.45) controlPoint2: CGPointMake(37.77, 21)];
    [rectangle4Path addCurveToPoint: CGPointMake(29.21, 12.97) controlPoint1: CGPointMake(37.77, 20) controlPoint2: CGPointMake(34.46, 14.97)];
    [rectangle4Path addCurveToPoint: CGPointMake(19.77, 12) controlPoint1: CGPointMake(23.96, 10.97) controlPoint2: CGPointMake(19.77, 12)];
    [rectangle4Path addLineToPoint: CGPointMake(19.02, 13.61)];
    ...
    [rectangle5Path moveToPoint: CGPointMake(21.83, 8.62)];
    [rectangle5Path addCurveToPoint: CGPointMake(31.56, 9.73) controlPoint1: CGPointMake(21.83, 8.62) controlPoint2: CGPointMake(26.31, 7.73)];
    [rectangle5Path addCurveToPoint: CGPointMake(39.85, 16.45) controlPoint1: CGPointMake(36.81, 11.73) controlPoint2: CGPointMake(39.85, 16.45)];
    [rectangle5Path addCurveToPoint: CGPointMake(40.77, 15) controlPoint1: CGPointMake(39.85, 16.45) controlPoint2: CGPointMake(40.77, 16)];
    [rectangle5Path addCurveToPoint: CGPointMake(32.21, 7.97) controlPoint1: CGPointMake(40.77, 15) controlPoint2: CGPointMake(37.46, 9.97)];
    [rectangle5Path addCurveToPoint: CGPointMake(22.77, 7) controlPoint1: CGPointMake(26.96, 5.97) controlPoint2: CGPointMake(22.77, 7)];
    [rectangle5Path addLineToPoint: CGPointMake(21.83, 8.62)];
...
+ (void)drawIconBlack
{
    ...
    //// Symbol Drawing
    CGRect symbolRect = CGRectMake(78, 36, 172, 260);
    CGContextSaveGState(context);
    UIRectClip(symbolRect);
    CGContextTranslateCTM(context, symbolRect.origin.x, symbolRect.origin.y);
    CGContextScaleCTM(context, symbolRect.size.width / 55, symbolRect.size.height / 83);
