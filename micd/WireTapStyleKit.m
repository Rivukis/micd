...
+ (void)drawHomeView
{
    ...
    UIColor* gradientColor = [UIColor colorWithRed: 0.114 green: 0.863 blue: 0.894 alpha: 1];
    UIColor* gradient2Color = [UIColor colorWithRed: 0.114 green: 0.886 blue: 0.914 alpha: 1];
...
+ (void)drawGripCircle
{
    ...
    UIColor* black = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 1];
    UIColor* gradientColor = [UIColor colorWithRed: 0.114 green: 0.863 blue: 0.894 alpha: 1];
    UIColor* gradientColor2 = [UIColor colorWithRed: 0.184 green: 0.584 blue: 0.651 alpha: 1];
    UIColor* gradient3Color = [UIColor colorWithRed: 0.875 green: 0.262 blue: 0.118 alpha: 1];
    UIColor* gradient3Color2 = [UIColor colorWithRed: 0.939 green: 0.093 blue: 0.093 alpha: 1];
    ...
    CGGradientRef gradient3 = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)gradient3Color.CGColor, (id)[gradient3Color blendedColorWithFraction: 0.5 ofColor: gradient3Color2].CGColor, (id)gradient3Color2.CGColor], gradient3Locations);
...
+ (void)drawMicdBackground
{
    ...
    CGContextSaveGState(context);
    [micdTitle3Path addClip];
    CGContextDrawRadialGradient(context, gradient,
        CGPointMake(-17.25, -7.52), 7.48,
        CGPointMake(-24.73, -0.04), 22.43,
    ...
    CGContextSaveGState(context);
    [micdTitle4Path addClip];
    CGContextDrawLinearGradient(context, gradient, CGPointMake(-20.99, -10.88), CGPointMake(-20.99, 3.33), 0);
    CGContextRestoreGState(context);
...
+ (void)drawSingleGearWithColor: (UIColor*)color positiveGearRotation: (CGFloat)positiveGearRotation
{
    ...
    //// Bezier Drawing
    CGContextSaveGState(context);
    CGContextRotateCTM(context, -positiveGearRotation * M_PI / 180);

    UIBezierPath* bezierPath = UIBezierPath.bezierPath;
    [bezierPath moveToPoint: CGPointMake(135.88, 0.24)];
    [bezierPath addCurveToPoint: CGPointMake(160.59, 31.12) controlPoint1: CGPointMake(138, 7.32) controlPoint2: CGPointMake(145.31, 27.48)];
    [bezierPath addCurveToPoint: CGPointMake(196.84, 20.07) controlPoint1: CGPointMake(175.8, 34.75) controlPoint2: CGPointMake(191.58, 24.08)];
    [bezierPath addCurveToPoint: CGPointMake(224.01, 43.35) controlPoint1: CGPointMake(206.95, 26.53) controlPoint2: CGPointMake(216.1, 34.38)];
    [bezierPath addCurveToPoint: CGPointMake(218.21, 80.34) controlPoint1: CGPointMake(220.76, 49.3) controlPoint2: CGPointMake(212.41, 66.77)];
    [bezierPath addCurveToPoint: CGPointMake(252.99, 100.29) controlPoint1: CGPointMake(224.82, 95.83) controlPoint2: CGPointMake(246.05, 99.5)];
    [bezierPath addCurveToPoint: CGPointMake(256, 128) controlPoint1: CGPointMake(254.96, 109.21) controlPoint2: CGPointMake(256, 118.49)];
    [bezierPath addCurveToPoint: CGPointMake(255.76, 135.97) controlPoint1: CGPointMake(256, 130.68) controlPoint2: CGPointMake(255.92, 133.34)];
    [bezierPath addCurveToPoint: CGPointMake(224.05, 160.77) controlPoint1: CGPointMake(248.86, 138.68) controlPoint2: CGPointMake(227.82, 147.91)];
    [bezierPath addCurveToPoint: CGPointMake(237.14, 194.91) controlPoint1: CGPointMake(220.37, 173.32) controlPoint2: CGPointMake(232.51, 189.38)];
    [bezierPath addCurveToPoint: CGPointMake(212.64, 224.03) controlPoint1: CGPointMake(230.45, 205.8) controlPoint2: CGPointMake(222.18, 215.61)];
    [bezierPath addCurveToPoint: CGPointMake(173.92, 219.46) controlPoint1: CGPointMake(206.52, 220.67) controlPoint2: CGPointMake(187.9, 211.8)];
    [bezierPath addCurveToPoint: CGPointMake(155.85, 252.96) controlPoint1: CGPointMake(159.95, 227.11) controlPoint2: CGPointMake(156.59, 246.39)];
    [bezierPath addCurveToPoint: CGPointMake(128, 256) controlPoint1: CGPointMake(146.88, 254.95) controlPoint2: CGPointMake(137.56, 256)];
    [bezierPath addCurveToPoint: CGPointMake(120, 255.75) controlPoint1: CGPointMake(125.31, 256) controlPoint2: CGPointMake(122.65, 255.92)];
    [bezierPath addCurveToPoint: CGPointMake(94.7, 224.92) controlPoint1: CGPointMake(117.93, 248.73) controlPoint2: CGPointMake(110.65, 228.45)];
    [bezierPath addCurveToPoint: CGPointMake(59.36, 236.06) controlPoint1: CGPointMake(78.97, 221.44) controlPoint2: CGPointMake(64.3, 231.99)];
    [bezierPath addCurveToPoint: CGPointMake(31.95, 212.61) controlPoint1: CGPointMake(49.15, 229.56) controlPoint2: CGPointMake(39.92, 221.65)];
    [bezierPath addCurveToPoint: CGPointMake(36.9, 174.34) controlPoint1: CGPointMake(35.42, 206.52) controlPoint2: CGPointMake(44.48, 188.17)];
    [bezierPath addCurveToPoint: CGPointMake(3.04, 155.85) controlPoint1: CGPointMake(29.37, 160.59) controlPoint2: CGPointMake(9.9, 156.78)];
    [bezierPath addCurveToPoint: CGPointMake(0, 128) controlPoint1: CGPointMake(1.05, 146.89) controlPoint2: CGPointMake(0, 137.57)];
    [bezierPath addCurveToPoint: CGPointMake(0.24, 120.1) controlPoint1: CGPointMake(0, 125.35) controlPoint2: CGPointMake(0.08, 122.71)];
    [bezierPath addCurveToPoint: CGPointMake(31.05, 95.27) controlPoint1: CGPointMake(7.41, 117.99) controlPoint2: CGPointMake(26.63, 110.95)];
    [bezierPath addCurveToPoint: CGPointMake(19.95, 59.34) controlPoint1: CGPointMake(35.53, 79.41) controlPoint2: CGPointMake(24.21, 64.31)];
    [bezierPath addCurveToPoint: CGPointMake(43.34, 31.99) controlPoint1: CGPointMake(26.44, 49.16) controlPoint2: CGPointMake(34.33, 39.95)];
    [bezierPath addCurveToPoint: CGPointMake(80.12, 37.82) controlPoint1: CGPointMake(49.25, 35.19) controlPoint2: CGPointMake(66.79, 43.52)];
    [bezierPath addCurveToPoint: CGPointMake(99.79, 3.12) controlPoint1: CGPointMake(93.49, 32.12) controlPoint2: CGPointMake(98.34, 10.64)];
    [bezierPath addCurveToPoint: CGPointMake(128, 0) controlPoint1: CGPointMake(108.87, 1.08) controlPoint2: CGPointMake(118.31, 0)];
    [bezierPath addCurveToPoint: CGPointMake(135.88, 0.24) controlPoint1: CGPointMake(130.64, 0) controlPoint2: CGPointMake(133.27, 0.08)];
    [bezierPath closePath];
    [bezierPath moveToPoint: CGPointMake(156.89, 94.21)];
    [bezierPath addCurveToPoint: CGPointMake(161.82, 156.97) controlPoint1: CGPointMake(175.58, 110.17) controlPoint2: CGPointMake(177.79, 138.28)];
    [bezierPath addCurveToPoint: CGPointMake(99.05, 161.92) controlPoint1: CGPointMake(145.85, 175.67) controlPoint2: CGPointMake(117.75, 177.88)];
    [bezierPath addCurveToPoint: CGPointMake(94.12, 99.15) controlPoint1: CGPointMake(80.36, 145.95) controlPoint2: CGPointMake(78.15, 117.85)];
    [bezierPath addCurveToPoint: CGPointMake(156.89, 94.21) controlPoint1: CGPointMake(110.1, 80.45) controlPoint2: CGPointMake(138.2, 78.24)];
    [bezierPath closePath];
    [bezierPath moveToPoint: CGPointMake(72.91, 80.37)];
    [bezierPath addCurveToPoint: CGPointMake(80.92, 182.36) controlPoint1: CGPointMake(46.96, 110.75) controlPoint2: CGPointMake(50.55, 156.41)];
    [bezierPath addCurveToPoint: CGPointMake(182.92, 174.33) controlPoint1: CGPointMake(111.3, 208.31) controlPoint2: CGPointMake(156.97, 204.71)];
    [bezierPath addCurveToPoint: CGPointMake(174.91, 72.33) controlPoint1: CGPointMake(208.87, 143.95) controlPoint2: CGPointMake(205.29, 98.28)];
    [bezierPath addCurveToPoint: CGPointMake(72.91, 80.37) controlPoint1: CGPointMake(144.53, 46.39) controlPoint2: CGPointMake(98.87, 49.98)];
    [bezierPath closePath];
    [color setFill];
    [bezierPath fill];
